...
import { cn, genHash } from "@/lib/utils";
...
export const DesktopSidebar = ({
  ...
  return (
    <div className="hidden sm:block">
      <motion.div
        className={cn(
          "relative h-full px-4 py-4 hidden sm:flex bg-neutral-100 dark:bg-neutral-800 rounded-tr-lg",
          className
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-12 px-4 py-4 flex flex-row sm:hidden items-center justify-between bg-neutral-100 dark:bg-neutral-800 w-full"
        )}
        {...props}
      >
